...
import sbt.{AllRequirements, AutoPlugin, Def, File, Project, Resolver, Setting, SettingKey, TaskKey, URL, settingKey, taskKey, url}
...
object ReactificPlugin extends AutoPlugin {
  ...
  val helpers: Seq[AutoPluginHelper] = {
    Seq(
      Commands, CompileQuick, Compiler, Miscellaneous, Site, Unidoc,
      BuildInfo, Header, Packaging, Publishing, Release
    )
  }
  ...
  object autoImport {
    ...
    val packageZip: TaskKey[File] = taskKey[File](
      "package-zip"
    )
